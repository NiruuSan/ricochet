...
export type PlayerData = Pick<Snapshot, "matches" | "active"> &
  Partial<
    Pick<Snapshot, "cashBalance" | "launch" | "player" | "isAdmin" | "notifications" | "unreadNotifications" | "tournaments" | "suspension" | "daily" | "friends" | "discountUntil" | "questsReady" | "theme">
